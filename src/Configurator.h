...
class Configurator {
 ...
 private:
  ...
  IotWebConfTextParameter apiUsernameParameter = IotWebConfTextParameter(
      "API username", "apiUsername", this->apiUsername, IOTWEBCONF_WORD_LEN);
  IotWebConfPasswordParameter apiPasswordParameter =
      IotWebConfPasswordParameter("API password", "apiPassword",
                                  this->apiPassword, IOTWEBCONF_PASSWORD_LEN);
